...
DUEL_PLAYER_SPAWN = (INITIAL_WORLD_X - 360, INITIAL_WORLD_Y)
DUEL_AI_SPAWN = (INITIAL_WORLD_X + 360, INITIAL_WORLD_Y)
...
# Duel mode overrides
DUEL_PREY_TARGET_COUNT = 600
DUEL_PREY_REFRESH_INTERVAL = 0.8
DUEL_SKILL_TARGET_COUNT = 36
DUEL_SKILL_REFRESH_INTERVAL = 4.0
